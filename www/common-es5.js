...
var PlayService = /** @class */ (function () {
    ...
    PlayService.prototype.partieFinie = function () {
        return this.nbQuestionsPosees === this.nbQuestionsTotales;
    };
    PlayService.prototype.shuffle = function (array) {
    ...
    PlayService.prototype.menuPrincipal = function () {
        this.typeKanas = "";
        this.sensJeu = "";
    ...
    PlayService.prototype.rejouer = function () {
        this.nbQuestionsPosees = 0;
        this.nbBonnesReponses = 0;
        this.caractere = "";
        this.propositions = ['', '', '', ''];
    ...
    PlayService.prototype.commencerPartie = function (typeKanas, sensJeu, nbQuestionsTotales) {
    ...
    PlayService.prototype.poserQuestion = function () {
        for (var i = 0; i < this.nbCaracteres; i++) {
            var indice = Math.floor(Math.random() * this.nbCaracteres + 1);
            var indicesProps = [];
            for (var j = 0; j < 3; j++)
                indicesProps.push(Math.floor(Math.random() * this.nbCaracteres + 1));
    ...
    PlayService.prototype.repondre = function (indice) {
    ...
    PlayService.prototype.reponseOk = function (indice) {
    ...
    PlayService.prototype.reponseNonOk = function (prop) {
        if (this.reponseCouranteFausse && prop == this.reponseChoisie)
            return true;
        else
            return false;
    };
    PlayService.prototype.questionSuivante = function () {
    ...
    PlayService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
