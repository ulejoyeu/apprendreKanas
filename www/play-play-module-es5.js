...
var PlayPage = /** @class */ (function () {
    ...
    PlayPage.prototype.questionSuivante = function () {
        if (this.playService.questionSuivante()) {
            this.couleurBouton = new Array();
            this.couleurBouton = ['medium', 'medium', 'medium', 'medium'];
        }
    };
    PlayPage.prototype.rejouer = function () {
        this.playService.rejouer();
        this.couleurBouton = new Array();
        this.couleurBouton = ['medium', 'medium', 'medium', 'medium'];
    };
    PlayPage.ctorParameters = function () { return [
